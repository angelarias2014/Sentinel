...
export const ASSETS = {
  [SUPPORTED_CHAINS.BASE]: [
    { symbol: "USDC", address: requiredAddress(import.meta.env.VITE_BASE_USDC_ADDRESS, "VITE_BASE_USDC_ADDRESS"), decimals: 6, vaultAddress: requiredAddress(import.meta.env.VITE_BASE_VAULT_ADDRESS, "VITE_BASE_VAULT_ADDRESS") },
    { symbol: "WETH", address: requiredAddress(import.meta.env.VITE_BASE_WETH_ADDRESS, "VITE_BASE_WETH_ADDRESS"), decimals: 18, vaultAddress: requiredAddress(import.meta.env.VITE_BASE_VAULT_ADDRESS, "VITE_BASE_VAULT_ADDRESS") },
  ].concat(optionalAddress(import.meta.env.VITE_BASE_CBBTC_ADDRESS) ? [{ symbol: "cbBTC", address: import.meta.env.VITE_BASE_CBBTC_ADDRESS!, decimals: 8, vaultAddress: requiredAddress(import.meta.env.VITE_BASE_VAULT_ADDRESS, "VITE_BASE_VAULT_ADDRESS") }] : [])
   .concat(optionalAddress(import.meta.env.VITE_BASE_DAI_ADDRESS) ? [{ symbol: "DAI", address: import.meta.env.VITE_BASE_DAI_ADDRESS!, decimals: 18, vaultAddress: requiredAddress(import.meta.env.VITE_BASE_VAULT_ADDRESS, "VITE_BASE_VAULT_ADDRESS") }] : [])
   .concat(optionalAddress(import.meta.env.VITE_BASE_USDBC_ADDRESS) ? [{ symbol: "USDbC", address: import.meta.env.VITE_BASE_USDBC_ADDRESS!, decimals: 6, vaultAddress: requiredAddress(import.meta.env.VITE_BASE_VAULT_ADDRESS, "VITE_BASE_VAULT_ADDRESS") }] : []),
...
export const VAULT_SYSTEM = {
  [SUPPORTED_CHAINS.BASE]: {
    ...
    AAVE_ADAPTER: requiredAddress(import.meta.env.VITE_BASE_AAVE_ADAPTER_ADDRESS || import.meta.env.VITE_BASE_ADAPTER_ADDRESS, "VITE_BASE_AAVE_ADAPTER_ADDRESS|VITE_BASE_ADAPTER_ADDRESS"),
    UNISWAP_ADAPTER: requiredAddress(import.meta.env.VITE_BASE_UNISWAP_ADAPTER_ADDRESS, "VITE_BASE_UNISWAP_ADAPTER_ADDRESS"),
    QUICKSWAP_ADAPTER: requiredAddress(import.meta.env.VITE_BASE_QUICKSWAP_ADAPTER_ADDRESS, "VITE_BASE_QUICKSWAP_ADAPTER_ADDRESS"),
    BALANCER_ADAPTER: requiredAddress(import.meta.env.VITE_BASE_BALANCER_ADAPTER_ADDRESS, "VITE_BASE_BALANCER_ADAPTER_ADDRESS")
  },
  [SUPPORTED_CHAINS.BASE_SEPOLIA]: {
...
export const PROTOCOLS = {
  [SUPPORTED_CHAINS.BASE]: {
    AAVE_V3_POOL: requiredAddress(import.meta.env.VITE_BASE_AAVE_V3_POOL, "VITE_BASE_AAVE_V3_POOL"),
    UNISWAP_V3_FACTORY: requiredAddress(import.meta.env.VITE_BASE_UNISWAP_V3_FACTORY, "VITE_BASE_UNISWAP_V3_FACTORY"),
